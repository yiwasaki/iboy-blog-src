...
│   └── VM: nsp-lab-vm (Standard_B2s, Windows Server 2022)
├── Bastion Developer (無料)
├── Storage Account (テスト用: iboysansp01)
│   └── Blob Container: nsp-test
├── Storage Account (診断用: iboysanspdiag01)
└── Network Security Perimeter
    ├── Profile: default-profile
    │   └── Access Rule: allow-subscription (Inbound)
...
| リソース | SKU | 月額概算 |
|---------|-----|---------|
| VM (Standard_B2s) | Burstable 2vCPU/4GB | ~$30 |
| Bastion Developer | Developer (無料) | $0 |
| Storage Account ×2 | Standard_LRS | ~$1 |
| NSP | - | $0 |
| OS Disk (128GB) | Standard_LRS | ~$5 |
| **合計** | | **~$36/月** |
